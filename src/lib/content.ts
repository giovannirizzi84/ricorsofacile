export const packages = [
  {
    ...
    features: [
      ...
      "Stima di costi e termini",
      "Report sintetico scaricabile",
    ],
    cta: "Analizza la multa",
    href: "/analizza",
  },
  {
    name: "Ricorso Smart",
    price: "€49",
    note: "da €49 a €79",
    description: "Per multe fino a €250 e casi adatti al ricorso al Prefetto.",
    features: [
      "Revisione dei documenti",
      "Ricorso al Prefetto personalizzato",
      "Istruzioni di deposito o invio",
      "Modello pronto alla firma",
      "Assistenza base via email",
    ],
    cta: "Scegli Smart",
    href: "/consulenza",
    featured: true,
  },
  {
    ...
    price: "€149",
    note: "a partire da",
    description: "Per pratiche complesse o importi più elevati.",
    features: [
      "Analisi professionale",
      "Redazione e gestione documenti",
      "Firma procura digitale",
