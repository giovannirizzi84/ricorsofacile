    ...
    <footer className="bg-[#0d2f2d] text-white">
      <div className="page-shell grid gap-12 py-16 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-5 max-w-md text-sm leading-6 text-white/65">
            Tecnologia e competenza per aiutarti a capire, in modo semplice e trasparente, se esistono basi concrete per contestare una multa.
          </p>
        </div>
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm text-white/70">
            ...
            <Link href="/consulenza" className="hover:text-white">Prenota consulenza</Link>
          </div>
        </div>
        <div>
      ...
      <div className="border-t border-white/10">
        <div className="page-shell flex flex-col gap-3 py-6 text-xs text-white/50 sm:flex-row sm:items-center sm:justify-between">
          <p>© 2026 RicorsoFacile AI. Progetto dimostrativo.</p>
