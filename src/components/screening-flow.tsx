                ...
                {step === 2 && (
                  <div>
                    <StepTitle
                      ...
                      text="In questa fase di test il pagamento è disattivato. OCR e regole lavorano localmente; Ollama viene usato solo se disponibile."
                    />
                    ...
                    <Actions
                      ...
                      nextLabel="Avvia analisi gratuita"
                    />
                  </div>
                )}
              </CardContent>
          ...
          <ReportSection title="Fatti estratti" icon={FileSearch}>
            ...
            <div className="grid gap-3 pt-2 sm:grid-cols-3">
              <InfoBox
                ...
                note="Elaborazione gratuita senza OpenAI"
              />
              <InfoBox
                label="Confidenza"
