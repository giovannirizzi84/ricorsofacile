...
export default function PrivacyPage() {
  return <LegalPage eyebrow="Informativa" title="Privacy Policy" description="Una sintesi trasparente di come vengono trattati dati e documenti nel prototipo." sections={[
    { title: "1. Titolare e finalità", text: "RicorsoFacile AI tratta i dati forniti per erogare lo screening preliminare, gestire richieste di consulenza e consentire l’accesso all’area riservata. I riferimenti definitivi del titolare saranno inseriti prima della pubblicazione." },
